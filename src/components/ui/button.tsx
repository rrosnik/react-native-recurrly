  ...
  ),
  {
    variants: {
      variant: {
        ...
        ghost: cn(
          'active:bg-primary/90 dark:active:bg-primary/50 active:text-white',
      ...
      size: {
        ...
        lg: cn('h-14 rounded-2xl px-6 sm:h-12', Platform.select({ web: 'has-[>svg]:px-4' })),
  ...
  ),
  {
    variants: {
      variant: {
        ...
        link: cn(
          'text-primary group-active:underline underline',
          Platform.select({ web: 'underline-offset-4 hover:underline group-hover:underline' })
        ),
        accent: cn("text-white font-sans-bold text-lg")
      },
      size: {
        default: '',
        sm: '',
